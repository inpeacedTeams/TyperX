...
class AppStore:
    ...
    def load(self) -> AppState:
        ...
        try:
            ...
            if int(raw.get("schema_version", 1)) < 2:
                profile_data["typo_rate"] = min(40.0, float(profile_data.get("typo_rate", 1.2)) * 10)
    ...
    def save(self, state: AppState) -> None:
        ...
        descriptor, temporary = tempfile.mkstemp(prefix="state-", suffix=".json", dir=self.data_dir)
        try:
